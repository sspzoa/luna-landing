...
const config: Config = {
  ...
  theme: {
    ...
    fontSize: {
      96: ['96px', { letterSpacing: '-2.88px' }],
      84: ['84px', { letterSpacing: '-2.52px' }],
      64: ['64px', { letterSpacing: '-1.92px' }],
      48: ['48px', { letterSpacing: '-1.44px' }],
      40: ['40px', { letterSpacing: '-1.2px' }],
      36: ['36px', { letterSpacing: '-1.08px' }],
      32: ['32px', { lineHeight: 1.8, letterSpacing: '-0.96px' }],
      24: ['24px', { letterSpacing: '-0.72px' }],
      20: ['20px', { lineHeight: 1.8, letterSpacing: '-0.6px' }],
      16: ['16px', { letterSpacing: '-0.48px' }],
      15: ['15px'],
      14: ['14px', { letterSpacing: '-0.42px' }],
      12: ['12px', { letterSpacing: '-0.36px' }],
    },
  },
  plugins: [],
};
